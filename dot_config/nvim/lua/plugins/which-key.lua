return {
	...
	config = function()
		...
		wk.add({
			...
			{ "<leader>bp", ":BufferLineCyclePrev<cr>", desc = "previous" },
			{ "<leader>bn", ":BufferLineCycleNext<cr>", desc = "next" },
			{ "<leader>bs", ":BufferLinePick<cr>", desc = "search" },
			{ "<leader>b<", ":BufferLineMovePrev<cr>", desc = "move previous" },
			{ "<leader>b>", ":BufferLineMoveNext<cr>", desc = "move next" },
			{ "<leader>b1", ":BufferLineGoToBuffer 1<CR>", desc = "goto 1" },
			{ "<leader>b2", ":BufferLineGoToBuffer 2<CR>", desc = "goto 2" },
			{ "<leader>b3", ":BufferLineGoToBuffer 3<CR>", desc = "goto 3" },
			{ "<leader>b4", ":BufferLineGoToBuffer 4<CR>", desc = "goto 4" },
			{ "<leader>b5", ":BufferLineGoToBuffer 5<CR>", desc = "goto 5" },
			{ "<leader>b6", ":BufferLineGoToBuffer 6<CR>", desc = "goto 6" },
			{ "<leader>b7", ":BufferLineGoToBuffer 7<CR>", desc = "goto 7" },
			{ "<leader>b8", ":BufferLineGoToBuffer 8<CR>", desc = "goto 8" },
			{ "<leader>b9", ":BufferLineGoToBuffer -1<CR>", desc = "goto last" },
			{ "<leader>bk", ":bd<cr>", desc = "kill" },
			{ "<leader>bd", group = "delete" },
			{ "<leader>bdd", ":bd<cr>", desc = "current" },
			{ "<leader>bda", ":bufdo bd<cr>", desc = "all" },
			{ "<leader>bdo", ":BufferLineCloseOthers<cr>", desc = "others" },
			{ "<leader>bdl", ":BufferLineCloseLeft<cr>", desc = "left" },
			{ "<leader>bdr", ":BufferLineCloseRight<cr>", desc = "right" },
			{ "<leader>o", group = "open" },
