...
This repo includes configs for macOS (managed with [[https://github.com/nix-darwin/nix-darwin][nix-darwin]], installed via [[https://determinate.systems/][Determinate Systems]]) and my riced up [[https://i3wm.org/][i3]] (I use [[https://archlinux.org/][arch]] btw...)
