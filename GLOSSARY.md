...
- **Corrections log**: the record of what João complained about, questioned, or
  asked to change in a corpus file, one entry per exchange, kept with the
  review-instructions skill and filed into the corrections rules.
