---
name: ship
description: Carries a directed push, release, deploy, or pull request through the project's documented route and observes the outcome. Use only when João has directed the shipping step. It does not run on its own initiative.
---
...
configuration, deploy scripts. Use that route rather than a generic equivalent. A
route you can't find is a question for João, with what you looked at.
