...
the rewrite bullet says why none of its designs was re-run. The brief output style and
/brief skill bullets were re-checked on 2026-09-24 on the same release and model. The
re-checks' commands, streams, transcripts, scores, and fixture are under
...
- **On Opus 5, the /brief skill's 101-word body and its 140-word body moved the
  ...
  but the one without the CEO clause lands inside 30 words of the kept length, and
