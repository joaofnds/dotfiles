---
name: review-docs
description: Reviews documentation for accuracy, reasoning, and fit for its readers. Use on maintained documentation or task records, including shaped cards, plans, and diagnoses, before they are called done. Agent instruction files go to review-instructions.
---

# Documentation review

Run adversarial-review with the Document criteria below included in its reviewer
mandate before dispatch. That skill owns the independent review, technical
verification, evidence, reporting, and finding dispositions. This skill supplies
the criteria for that same review.
