...
- **`the style skill`'s "solely to satisfy this document" outranks this refactoring**: never introduce a class merely
...
- `the style skill`: "do not introduce classes … solely to satisfy this document."
...
- `the style skill`: put domain behavior with the model it governs, using "a class,
...
- `the style skill`: Beck's ordering: the class is an added element and must buy
