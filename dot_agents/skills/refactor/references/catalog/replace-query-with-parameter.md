...
- `the style skill`: control non-deterministic side effects: "pass clocks,
...
- `the style skill`: inject side-effecting or replaceable dependencies: for a
...
- `the doctrine skill`: listen to the tests: needing to monkey-patch a
