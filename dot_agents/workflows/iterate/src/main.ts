  ...
  try {
    const result = await session({
      ...
      systemPrompt: [
        ...
        ...(resume
          ? [
              "Continue only this author role. Re-read backlog/PRIORITY.md and the current card and check source/environment drift.",
            ]
          : []),
      ].join("\n\n"),
