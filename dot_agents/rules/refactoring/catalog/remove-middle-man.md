...
- `coding_style.md:58` — Tell, Don't Ask pulls toward Hide Delegate; this refactoring
...
- `engineering_judgment.md:37` — code is a liability: N forwarding methods are N
