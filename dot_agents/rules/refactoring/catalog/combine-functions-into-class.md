...
- **`coding_style.md:8` outranks this refactoring**: never introduce a class merely
...
- `coding_style.md:8` — "do not introduce classes … solely to satisfy this document."
...
- `coding_style.md:66` — put domain behavior with the model it governs, using "a class,
...
- `coding_style.md:12` — Beck's ordering: the class is an added element and must buy
