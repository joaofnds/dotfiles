...
- `coding_style.md:15` — move understanding from your head into the code: tracking
...
- `coding_style.md:12` — Beck's ordering: three honest names beat one lying name on
