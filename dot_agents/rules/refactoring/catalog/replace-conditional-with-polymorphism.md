...
- **One switch, one place**: a single conditional over a closed set is clear, honest
  code — `coding_style.md:8` forbids conjuring a class hierarchy to satisfy a
...
- `coding_style.md:8` — the hierarchy (or table) is an introduced element; a single
...
- `coding_style.md:19` — leverage the type system: in typed languages, prefer the
