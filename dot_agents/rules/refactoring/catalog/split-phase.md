...
- `coding_style.md:45` — safe parsing at boundaries: when the first phase ingests
...
- `engineering_judgment.md:22` — draw boundaries at the demonstrated cost inflection: a
...
- `coding_style.md:12` — Beck's ordering: the intermediate structure is an added
