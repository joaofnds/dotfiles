...
- `engineering_judgment.md:62` — a good change narrows the space of future bugs: the
  entire class "update site forgot the derived value" is eliminated, not patched.
- `engineering_judgment.md:12` — facts before theories: the performance case for
