...
- `coding_style.md:20` — don't defend against your own code: if *you* decide whether
...
- `engineering_judgment.md:41` — DRY over knowledge: the duplicated default ("occupant")
  is one business fact encoded N times; the object makes it one.
- `coding_style.md:8` — a class is not required — a frozen literal satisfies the
