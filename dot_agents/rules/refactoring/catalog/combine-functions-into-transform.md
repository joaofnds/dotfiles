...
- `coding_style.md:49` — transformations are "stateless, non-mutating translators …
...
- `coding_style.md:8` — where this refactoring and Combine Functions into Class both
  fit, the transform wins by default: it delivers the single change site without
  introducing a class.
- `engineering_judgment.md:29` — complexity carries the burden of proof: the transform
