...
- **`coding_style.md:8` outranks the book**: a primitive that is only stored and
...
- `coding_style.md:19` — leverage the type system: an opaque string sniffed at each
  use is a runtime cast in disguise; parsing once into a real type at the boundary is
  the sanctioned shape.
- `coding_style.md:8` — the class must be earned by demonstrated duplicated behavior
  or invalid states, never introduced for taxonomy.
- `coding_style.md:45` — safe parsing at boundaries: the value object's validating
