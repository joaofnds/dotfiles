...
- `coding_style.md:33` — behavior lives with data, read in both directions: the field
...
- `engineering_judgment.md:37` — code is a liability: a never-meaningful inherited
