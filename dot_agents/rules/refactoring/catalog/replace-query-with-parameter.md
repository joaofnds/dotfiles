...
- `coding_style.md:60` — control non-deterministic side effects: "pass clocks,
...
- `coding_style.md:68` — inject side-effecting or replaceable dependencies: for a
...
- `engineering_judgment.md:43` — listen to the tests: needing to monkey-patch a
