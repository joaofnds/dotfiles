...
- `engineering_judgment.md:42` — orthogonality: hoisting statements to N call sites
...
- `coding_style.md:17` — surgical execution: migrate the callers this task touches;
