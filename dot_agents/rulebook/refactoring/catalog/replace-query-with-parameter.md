...
- `core.md`: control non-deterministic side effects: "pass clocks,
...
- `core.md`: inject side-effecting or replaceable dependencies: for a
...
- `engineering.md`: listen to the tests: needing to monkey-patch a
