...
- **`core.md`'s "solely to satisfy this document" outranks this refactoring**: never introduce a class merely
...
- `core.md`: "do not introduce classes … solely to satisfy this document."
...
- `core.md`: put domain behavior with the model it governs, using "a class,
...
- `core.md`: Beck's ordering: the class is an added element and must buy
