...
- `core.md`: don't defend against your own code: if *you* decide whether
...
- `engineering.md`: DRY over knowledge: the duplicated default ("occupant")
  is one business fact encoded N times; the object makes it one.
- `core.md`: a class is not required: a frozen literal satisfies the
