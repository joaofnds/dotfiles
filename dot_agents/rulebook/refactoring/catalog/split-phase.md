...
- `core.md`: safe parsing at boundaries: when the first phase ingests
...
- `engineering.md`: draw boundaries at the demonstrated cost inflection: a
...
- `core.md`: Beck's ordering: the intermediate structure is an added
